...
$sql = "SELECT * FROM university WHERE featured = 2";
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tshs 50000</span>
          <p><?= $university['des1'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 200,000 <br> Tsh 250,0000 </span>
          <p> <?= $university['des2'];?></p>
          <a href="#" class="mu-book-now-btn">For more details <br>Subscribe here</a>
        </div>
      </div>
     </div>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">60,000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="#" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
