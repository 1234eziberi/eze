...
$sql = "SELECT * FROM university WHERE featured = 100";
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tshs 30,000</span>
          <p><?= $university['des1'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 20,000 or <br>Tshs 25,000 </span>
          <p> <?= $university['des2'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <p><?= $university['des3'];?></p>
          <a href="booking" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
    </div>
    <?php endwhile; ?>
