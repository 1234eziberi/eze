...
$sql = "SELECT * FROM university WHERE featured = 81";
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tshs 50,000</span>
          <p><?= $university['des1'];?></p>
          <a href="#" class="mu-book-now-btn">For more details join<br>Subscribe here</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 20,000 or <br>Tshs 30,000 </span>
          <p> <?= $university['des2'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">40,000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
...
<span style="color: orange;">avoid scammers</span>, instead it makes us to be aware of your preference so as you being redirected to 
  our real estate  broker's agencies(dalali smart) for available,cheap and customer prefferences with 30%off brokership price service.You will not be 
