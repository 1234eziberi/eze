...
$sql = "SELECT * FROM university WHERE featured = 1";
...
<head>
    ...
    <title>Ruaha Catholic University</title>
    ...
    <link href="UNIVERSITIES/css/font-awesome.min.css" rel="stylesheet" />
    <!-- Poppins For Title -->
...
<div class="row">
    <div class="column">
      <img src="IMAGES/Ezbel/IMG_20240217_134950.jpg" alt="" width="100%" onclick="myFunction(this);">
    </div>
    <div class="column">
      <img src="images/muh1.jpg" alt=" " width="100%" onclick="myFunction(this);">
    </div>
    <div class="column">
      <img src="images/muh2.jpg" alt=" " width="100%" onclick="myFunction(this);">
    </div>
    <div class="column">
      <img src="images/muh3.jpg" alt=" " width="100%" onclick="myFunction(this);">
    </div>
    <div class="column">
        <img src="images/muh4.jpg" alt=" " width="100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="images/muh5.jpg" alt="" width="100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="images/mu6.jpg" alt="" width="100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="images/Ezbel/IMG_20240217_134806.jpg" alt="" width="100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="images/Ezbel/IMG_20240217_134934.jpg" alt="" width="100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="images/Ezbel/IMG_20240217_134903.jpg" alt="" width="100%" onclick="myFunction(this);">
      </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        <!-- <img src="<?= $university['img1'];?>" width="400px" height="640px" alt="img"> -->
        <div class="mu-featured-tours-single-info">
          <h3>Location:<?= $university['loc1'];?></h3>
          <h4>  Standard quality</h4>
          <span class="mu-price-tag">Tshs 70,000</span>
          <p><?= $university['des1'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details join<br>Subscribe here</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        <!-- <img src="<?= $university['img2'];?>" width="400px" height="600px" alt="<?= $university['loc1'];?>"> -->
        <div class="mu-featured-tours-single-info">
          <h3>Location:<?= $university['loc2'];?> </h3>
          <h4> low quality, Standard quality</h4>
          <span class="mu-price-tag">Tsh 70,0000 <br>Tshs 80,000 </span>
          <p> <?= $university['des2'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details <br>Subscribe here</a>
        </div>
      </div>
     </div>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">90,000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
...
<span style="color: orange;">avoid scammers</span>, instead it makes us to be aware of your preference so as you being redirected to 
  our real estate  broker's agencies(dalali smart) for available,cheap and customer prefferences with 35%off brokership price service.You will not be 
