...
$sql = "SELECT * FROM university WHERE featured = 42";
...
<meta charset="UTF-8">
    ...
    <title>Catholic University of health with Allied Sciences</title>
...
<!-- <div class="row">
    ...
    <div class="column">
      <img src="IMAGES/Ezbel/IMG_20240217_134734.jpg" alt=" " width="100%" onclick="myFunction(this);">
    </div>
    <div class="column">
      <img src="IMAGES/Ezbel/IMG_20240217_134734.jpg" alt=" " width="100%" onclick="myFunction(this);">
    </div>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tshs 70000</span>
          <p><?= $university['des1'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 60,0000 or <br>Tshs 70,000 </span>
          <p> <?= $university['des2'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">90000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
