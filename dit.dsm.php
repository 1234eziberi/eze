...
$sql = "SELECT * FROM university WHERE featured = 11";
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tshs 60,000</span>
          <p><?= $university['des1'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 50,000 or <br>Tshs 60,000 </span>
          <p> <?= $university['des2'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">80,000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
