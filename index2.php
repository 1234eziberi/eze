...
<body>
          ...
          <div class="service_owl-carousel owl-carousel">
            <div class="item">
              <div class="box ">
                ...
                <div class="detail-box">
                  <h5>
                   <a href="UNIVERSITIES/university2.php"> link to university</a>
                  </h5>
                  <p>
            ...
            <div class="item">
              <div class="box ">
                ...
                <div class="detail-box">
                  ...
                  <p>          Je unataka uahirishe mwaka wa masomo?,Je hauna mwafaka wa kozi ya kusoma chuo kikuu? Unataka uache masomo?
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        JIFUNZE HUB is a community of intellectuals into various fields of study .our motive is to provide accurate and 
            and accredited informations to young scholars in universities,colleges and secondary schools .our team consists of humble 
        proffessionals who provide career guidance and counseling Our community consists of humble professionals into various fields <br>
        who are experienced enough to guide you therefore are ready to share and<br> 
        guide young scholars and learners towards right educational destiny..Furthermore we link students from high school to higher learning institutions
    to various places in the country and outside the country
    <br>
    DISCLAIMER:all the information and advices provided in the website are just some people's opinions and views ,Should not be 
  ...
  <!-- about section ends -->
   <h2 class="freshers">*Commonly asked questions by freshers</h2>
...
<button class="accordion">3.Nini maana ya disco?</a></button>
<div class="panel">
...
<button class="accordion">14.Eti mahusiano chuo kikuu ni hayakwepeki?</button>
<div class="panel">
            ...
            <div class="row">
              <div class="col-lg-7 col-md-9 mx-auto">
                <div class="client_container ">
                  <div class="img-box">
                    <img src="images/Ezbel/master.jpg" width="250px" height="250px" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      ezberi chuma
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">JifunzeHub</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
