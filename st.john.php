...
$sql = "SELECT * FROM university WHERE featured = 52";
...
<head>
    ...
    <title>St.John University of health with Allied Sciences</title>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">Tsh 40,000 or <br>Tshs 50,000 </span>
          <p> <?= $university['des2'];?></p>
    ...
    <div class="col-md-4">
      <div class="mu-featured-tours-single">
        ...
        <div class="mu-featured-tours-single-info">
          ...
          <span class="mu-price-tag">7 0,000Tshs</span>
          <p><?= $university['des3'];?></p>
          <a href="booking.php" class="mu-book-now-btn">For more details<br>Subscribe here</a>
        </div>
      </div>
